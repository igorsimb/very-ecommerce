...
@pytest.fixture
def create_admin_user(django_user_model):  # django_user_model is from pytest-django
    """
    Return admin user
    """
    return django_user_model.objects.create_superuser("admin", "a@a.com", "testing321")

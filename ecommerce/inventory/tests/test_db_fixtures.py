...
def test_inventory_db_product_inventory_dataset(
        db, db_fixture_setup, id, sku, upc, product_type, product, brand,
        is_active, retail_price, store_price, sale_price, weight, created_at, updated_at
):
...
def test_inventory_db_media_dataset(
        db, db_fixture_setup, id, product_inventory, image, alt_text,
